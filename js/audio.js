...
const SOUNDS = {
  ...
  hobgoblin_aggro:    { src: 'assets/audio/combat/hobgoblin aggro.mp3',     category: 'combat' },
  hobgoblin_attack:   { src: 'assets/audio/combat/hobgoblin attack.mp3',    category: 'combat' },
  hobgoblin_moving:   { src: 'assets/audio/combat/hobgoblin moving.mp3',    category: 'combat' },
  hobgoblin_chief_aggro:  { src: 'assets/audio/combat/hobgoblin chief aggro.mp3',  category: 'combat' },
  hobgoblin_chief_attack: { src: 'assets/audio/combat/hobgoblin chief attack.mp3', category: 'combat' },
  hobgoblin_chief_moving: { src: 'assets/audio/combat/hobgoblin chief moving.mp3', category: 'combat' },
  hyena_aggro:        { src: 'assets/audio/combat/hyena aggro.mp3',         category: 'combat' },
  hyena_attack:       { src: 'assets/audio/combat/hyena attack.mp3',        category: 'combat' },
  hyena_moving:       { src: 'assets/audio/combat/hyena moving.mp3',        category: 'combat' },
  gnoll_aggro:        { src: 'assets/audio/combat/gnoll aggro.mp3',         category: 'combat' },
  gnoll_attack:       { src: 'assets/audio/combat/gnoll attack.mp3',        category: 'combat' },
  gnoll_moving:       { src: 'assets/audio/combat/gnoll moving.mp3',        category: 'combat' },
  owlbear_aggro:      { src: 'assets/audio/combat/owlbear aggro.mp3',       category: 'combat' },
  owlbear_attack:     { src: 'assets/audio/combat/owlbear attack.mp3',      category: 'combat' },
  owlbear_moving:     { src: 'assets/audio/combat/owlbear moving.mp3',      category: 'combat' },
  kobold_aggro:       { src: 'assets/audio/combat/kobold aggro.mp3',        category: 'combat' },
  kobold_attack:      { src: 'assets/audio/combat/kobold attack.mp3',       category: 'combat' },
  kobold_moving:      { src: 'assets/audio/combat/kobold move.mp3',         category: 'combat' },
  ...
  swarm_aggro:        { src: 'assets/audio/combat/swarm of insects aggro.mp3',  category: 'combat' },
  swarm_attack:       { src: 'assets/audio/combat/swarm of insects attack.mp3', category: 'combat' },
  swarm_moving:       { src: 'assets/audio/combat/swarm of insects moving.mp3', category: 'combat' },
  spider_aggro:       { src: 'assets/audio/combat/spider aggro.mp3',        category: 'combat' },
  spider_attack:      { src: 'assets/audio/combat/spider attack.mp3',       category: 'combat' },
  spider_moving:      { src: 'assets/audio/combat/spider moving.mp3',       category: 'combat' },
  rat_aggro:          { src: 'assets/audio/combat/rat aggro.mp3',           category: 'combat' },
  rat_attack:         { src: 'assets/audio/combat/rat attack.mp3',          category: 'combat' },
  rat_moving:         { src: 'assets/audio/combat/rat moving.mp3',          category: 'combat' },
  ...
  morvath_melee:    { src: 'assets/audio/combat/morvath melee.wav',                  category: 'combat' },
...
const UNIT_SOUNDS = {
  ...
  gnoll:           { aggro: 'gnoll_aggro',       attack: 'gnoll_attack',     move: 'gnoll_moving' },
  gnoll_pack_lord: { aggro: 'gnoll_aggro',       attack: 'gnoll_attack',     move: 'gnoll_moving' },
  gnoll_fang:      { aggro: 'gnoll_aggro',       attack: 'gnoll_attack',     move: 'gnoll_moving' },
  owlbear:         { aggro: 'owlbear_aggro',     attack: 'owlbear_attack',   move: 'owlbear_moving' },
  kobold:          { aggro: 'kobold_aggro',      attack: 'kobold_attack', move: 'kobold_moving' },
  ...
  swarm_of_insects:       { aggro: 'swarm_aggro',   attack: 'swarm_attack',  move: 'swarm_moving' },
  giant_spider:           { aggro: 'spider_aggro',  attack: 'spider_attack', move: 'spider_moving' },
  giant_rat:              { aggro: 'rat_aggro',     attack: 'rat_attack',    move: 'rat_moving' },

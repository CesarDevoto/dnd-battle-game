    ...
    rows: [
      {
        ...
        defaults: {
          ...
          dwarf:    ['ally_lowest_hp', 'ally_any_wounded', 'nearest', 'lowest_hp', 'most_dangerous', 'most_clustered'],
          human:    ['nearest', 'most_dangerous', 'lowest_hp', 'most_clustered'],
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        defaults: {
          elf:      ['dodge', 'delay_action', 'end_turn', 'dash'],
          dwarf:    ['healing_word', 'dodge', 'delay_action', 'end_turn', 'dash'],
          human:    ['delay_action', 'dodge', 'end_turn', 'dash'],
          halfling: ['dodge', 'delay_action', 'end_turn', 'dash'],
        },
        appliesTo: () => true,
      },
    ],
    ...
    rows: [
      {
        ...
        options: [
          { value: 'enemy_enters_los',         label: 'Enemy enters LOS'         },
          { value: 'enemy_enters_ranged_range', label: 'Enemy enters ranged range' },
          { value: 'enemy_enters_melee_range',  label: 'Enemy enters melee range'  },
          { value: 'ally_takes_damage',         label: 'Ally takes damage'         },
        ],
        defaults: {
          elf:      ['enemy_enters_ranged_range', 'enemy_enters_los', 'enemy_enters_melee_range', 'ally_takes_damage'],
          dwarf:    ['ally_takes_damage', 'enemy_enters_melee_range', 'enemy_enters_ranged_range', 'enemy_enters_los'],
          human:    ['enemy_enters_melee_range', 'enemy_enters_los', 'enemy_enters_ranged_range', 'ally_takes_damage'],
          halfling: ['enemy_enters_ranged_range', 'enemy_enters_los', 'enemy_enters_melee_range', 'ally_takes_damage'],
        },
        appliesTo: () => true,
      },
    ],

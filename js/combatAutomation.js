    ...
    rows: [
      {
        ...
        defaults: {
          elf:      ['enemy_enters_ranged_range', 'enemy_enters_melee_range', 'enemy_enters_los', 'ally_takes_damage'],
          dwarf:    ['ally_takes_damage', 'enemy_enters_melee_range', 'enemy_enters_ranged_range', 'enemy_enters_los'],
          human:    ['enemy_enters_ranged_range', 'enemy_enters_melee_range', 'enemy_enters_los', 'ally_takes_damage'],
          halfling: ['enemy_enters_ranged_range', 'enemy_enters_melee_range', 'enemy_enters_los', 'ally_takes_damage'],
        },
        appliesTo: () => true,
      },
    ],

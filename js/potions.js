...
export const POTIONS = {
  ...
  potion5:  { id: 'potion5',  name: 'Potion of Lesser Healing', rarity: 'grey', icon: 'assets/items/potions/potion5.png',
    heal: '2d4+2', description: 'A minor restorative brew. Drink to regain 2d4+2 hit points.' },
